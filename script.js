...
(function() {
  var by_id, by_id_set, by_id_value, calculate, chalk, field, fields, fields_all, fn, hash_get, hash_set, j, last_changed, len, result_show, values_default,
    indexOf = [].indexOf;
...
taxes: ${r(tax_sia + tax_vsaoi + tax_risk + tax_iin_total, 3)}`
  ...
  fields_all.forEach(function(field) {
    return by_id(field).onkeyup = function() {
  ...
  by_id_set('min', hash_get('min') || values_default['min']);
